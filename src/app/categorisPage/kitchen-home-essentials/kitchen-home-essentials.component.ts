...
@Component({
  selector: 'app-kitchen-home-essentials',
  imports: [FooterComponent, NavbarComponent],
  templateUrl: './kitchen-home-essentials.component.html',
  styleUrl: '../clothes-fashion/clothes-fashion.component.css'
})
export class KitchenHomeEssentialsComponent {
...
isAll = true;
  ...
  constructor(private router:Router,private productService: ProductService, private photoService: PhotoService, private favoriteService:FavoriteService ){}
    ...
    this.productService.getProductByType("Kitchen & Home essentials").subscribe({
      next: (res) => {
        console.log("Kitchen & Home essentials", res);
        this.listAll = res
