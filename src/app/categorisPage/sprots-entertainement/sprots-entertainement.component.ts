...
@Component({
  selector: 'app-sprots-entertainement',
  imports: [FooterComponent, NavbarComponent],
  templateUrl: './sprots-entertainement.component.html',
  styleUrl: '../clothes-fashion/clothes-fashion.component.css'
})
export class SprotsEntertainementComponent {
...
isAll = true;
  ...
  constructor(private router:Router,private productService: ProductService, private photoService: PhotoService, private favoriteService:FavoriteService ){}
    ...
    this.productService.getProductByType("Sprots & Entertainement").subscribe({
      next: (res) => {
        console.log("Sprots & Entertainement", res);
        this.listAll = res
