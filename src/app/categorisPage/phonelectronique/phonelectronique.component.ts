...
@Component({
  selector: 'app-phonelectronique',
  imports: [NavbarComponent, FooterComponent],
  templateUrl: './phonelectronique.component.html',
  styleUrl: '../clothes-fashion/clothes-fashion.component.css'
})
export class PhonelectroniqueComponent {
...
isAll = true;
  ...
  constructor(private router:Router,private productService: ProductService, private photoService: PhotoService, private favoriteService:FavoriteService ){}
    ...
    this.productService.getProductByType("Phone & Electronique").subscribe({
      next: (res) => {
        console.log("Phone & Electronique", res);
        this.listAll = res
